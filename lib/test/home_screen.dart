...
import 'package:first_firebase/test/product_detail_screen.dart';
import 'package:first_firebase/test/story_screen.dart';
...
// });
  ...
  buildDynamicLinks(String title, String image, String docId) async {
    String url = "http://dynamiclinkmy1.page.link";
    final DynamicLinkParameters parameters = DynamicLinkParameters(
      uriPrefix: url,
      link: Uri.parse('$url/$docId'),
      androidParameters: AndroidParameters(
        packageName: "com.example.first_firebase",
        minimumVersion: 0,
      ),
                          ...
                          child: Column(
                            children: [
                              InkWell(
                                onTap: () {
                                  Get.to(
                                      () => ProductDetailScreen(ads[index].id));
                                },
                                child: Container(
                                  width: Get.width,
